...
const createGalleryItemTamplate = (item) => {
...
const galleryItemsTamplate = images
  .map((item) => createGalleryItemTamplate(item))
  .join("");

refs.galleryList.innerHTML = galleryItemsTamplate;
